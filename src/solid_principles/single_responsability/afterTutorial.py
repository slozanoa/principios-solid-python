...
class PaymentServices:
    ...
    notifaier: Notifier = field(default_factory=EmailNotifier)
    ...
    def process_transaction(self, customer_data, payment_data) -> Charge:
        ...
        try:
            ...
            self.notifaier.send_confirmation(customer_data)
...
if __name__ == "__main__":
    sms_notifier = SMSNotifier(sms_gateway="this is sms mock gateway")
    payment_services = PaymentServices()

    payment_services_sms_notifier = PaymentServices(notifaier=sms_notifier)
    ...
    payment_services_sms_notifier.process_transaction(
        customer_data_with_email, payment_data
    )
    payment_services.process_transaction(
